...
<head>
    ...
    <title>Estoque - Cadastro de Saída</title> </head>
<body>
<!--NAVBAR-->
...
<div class="main">
    <div class="section">
        <div class="container">
            <h3 style="margin-top:1%;text-align:center">Cadastro de Saída</h3>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <form method="POST" action="<c:url value="/saida/novo"/>">
                        ...
                        <a href="<c:url value="/saida/listar"/>" class="btn btn-outline-secondary">Voltar</a>
                    </form>
                </div>
            </div>
